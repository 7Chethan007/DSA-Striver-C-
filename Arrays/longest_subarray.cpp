...
// Brute force optimisation - O(n^2):
...
// when -ve , 0 ,+ve numbers are present in the array
...
// Optimised Approach using 2 pointers - O(2n):
// when 0 and +ve numbers are present in the array
